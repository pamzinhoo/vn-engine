...
translate spanish strings:
    ...
    # Confirmação de sair do jogo e de voltar ao menu principal.
    # Traduções feitas junto com o painel novo — revisar com falante nativo.

    # renpy/common/00gui.rpy:452
    old "Are you sure you want to quit?"
    new "¿Deseas salir del juego?"
...
translate spanish strings:
    ...
    new "¿Seguro que quieres sobrescribir la partida guardada?"
